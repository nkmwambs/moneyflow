                ...
                <form role="form" name="accadd" method="post" action="{$_url}settings/app-post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="theme" id="theme" class="form-control">
                            <option value="sysfrm" {if $_c['theme'] eq 'sysfrm'}selected="selected" {/if}>Sysfrm</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="nstyle" id="nstyle" class="form-control">
                            ...
                            <option value="ria" {if $_c['nstyle'] eq 'ria'}selected="selected" {/if}>Ria</option>
                    ...
                    <div class="form-group">
                        <label for="rtl">Theme Style</label>
